...
import module namespace dct="http://www.edirom.de/xquery/xqsuite/dts-util-tests" at "dts-util-tests.xqm";
...
test:suite((
    ...
    util:list-functions("http://www.edirom.de/xquery/xqsuite/dts-util-tests"),
